...
class ExportBarangTerkonfirmasi implements FromQuery, WithHeadings
{
    use Exportable;
    /**
    ...
    {
        $datadetil = DB::table('konfirmhilangkembali as a')
            ->select(['a.idbarang as idbarang',
                ...
                'a.statusbarang as statusbarang','a.statushenti','a.statususul','a.statushapus'])
       ...
       //echo json_encode($data);
        ...
        else if ($statusbarang == "statushenti"){
            $where = array(
                'statushenti' => 1
            );
            $datadetil = $datadetil->where($where);
    ...
    {
        return ['IDBarang','Kode Barang','NUP','Uraian Barang','Tahun Perolehan','Merek','Area','Gedung','Ruangan', 'Status Barang', 'Status Henti','Status Usul','Status Hapus'];
    }
}
