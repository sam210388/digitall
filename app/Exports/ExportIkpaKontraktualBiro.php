...
class ExportIkpaKontraktualBiro implements FromQuery, WithHeadings
{
    use Exportable;
    /**
    ...
    public function query()
    {
        ...
        $data = DB::table('ikpakontraktualbiro as a')
    ...
    public function headings(): array
    {
        return ['TA','Satker','Periode','IDBiro','IDBagian','Jumlah Kontrak','Nilai Ketepatan Waktu','Jumlah Kontrak TW I','Jumlah Kontrak Akselerasi',
            'Nilai Komponen Akselerasi','Jumlah Kontrak 53','Jumlah Kontrak 53 Akselerasi','Nilai Komponen 53','Nilai','Biro'];
    }
