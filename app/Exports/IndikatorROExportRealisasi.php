...
class IndikatorROExportRealisasi implements FromQuery, WithHeadings, WithPreCalculateFormulas
{
    use Exportable;
    /**
    ...
    public function query()
    {
        ...
        $data = DB::table('indikatorro as a')
            ...
            ->leftJoin('laporanrealisasianggaranbac as b','a.id','=','b.idindikatorro')
    ...
    {
       return ['Indikator RO','Target','Biro','Deputi',
           'Anggaran Indikator RO',
