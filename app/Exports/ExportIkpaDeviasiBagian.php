...
class ExportIkpaDeviasiBagian implements FromQuery, WithHeadings
{
    use Exportable;
    /**
    ...
    public function query()
    {
        ...
        $data = DB::table('ikpadeviasibagian as a')
    ...
    public function headings(): array
    {
        return ['TA','Satker','IDBagian','IDBiro','Periode','Rencana51','Rencana52','Rencana53','Penyerapan51','Penyerapan51','Penyerapan51',
            ...
            'JenisBelanjaDikelola','RerataDeviasiJenisBelanja','RerataDeviasiKumulatif','NilaiIkpa','created_at','updated_at','Biro','Bagian'];
    }
