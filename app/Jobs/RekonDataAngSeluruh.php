...
class RekonDataAngSeluruh implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $dataidrefstatus = DB::table('ref_status')->where('tahunanggaran','=',$tahunanggaran)->get();
        foreach ($dataidrefstatus as $item) {
            $idrefstatus = $item->idrefstatus;
