...
class HitungIkpaRevisiBiro implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $sppheader = new IKPARevisiBagianController();
        $sppheader = $sppheader->aksiperhitunganikparevisibiro($tahunanggaran);
    }
}
