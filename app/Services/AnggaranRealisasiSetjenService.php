...
class AnggaranRealisasiSetjenService
{
    ...
    private function calculateDeviasi($pokikpasdbulanberjalan, $realisasisetjensd, $paguanggaransetjen)
    {
        if ($pokikpasdbulanberjalan > 0 && $realisasisetjensd > 0) {
            $rencana = ($pokikpasdbulanberjalan / $paguanggaransetjen) * 100;
            $deviasi = $realisasisetjensd - $pokikpasdbulanberjalan;
            $persentaseDeviasi = ($deviasi / $pokikpasdbulanberjalan) * 100;
        } elseif ($pokikpasdbulanberjalan == 0 && $realisasisetjensd > 0) {
            $rencana = 0;
            $deviasi = $realisasisetjensd - $pokikpasdbulanberjalan;
