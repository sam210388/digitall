                ...
                <div class="card">
                    <div class="card-header">
                        <div class="btn-group float-sm-right">
                            ...
                            <a class="btn btn-info float-sm-right" href="javascript:void(0)" id="hitungikpa">Hitung IKPA Caput</a>
                        </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.tabelrealisasibagianperpengenal').DataTable({
                ...
                ajax:"{{route('getdatamonitoringikpacaput','')}}"+"/"+idbagian,
                columns: [
            ...
            $('#hitungikpa').click(function (e) {
                if( confirm("Apakah Anda Yakin Mau Menghitung IKPA Capaian Output Bagian Sekarang ?")){
                    e.preventDefault();
                    $(this).html('Processing..');
                    window.location="{{URL::to('hitungikpacaputbagian')}}";
                }
            });
            ...
            $('#exportikpa').click(function (e) {
                if( confirm("Apakah Anda Yakin Mau Eksport Data IKPA Caput ?")){
                    e.preventDefault();
                    $(this).html('Exporting..');
                    window.location="{{URL::to('exportikpacaputbagian')}}";
                    $(this).html('Export');
                }
            });
        });
