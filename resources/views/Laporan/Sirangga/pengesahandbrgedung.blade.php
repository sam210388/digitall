...
@foreach($datareferensidbr as $drd)
    <table>
        ...
        <tr>
            <td class="left">ID GEDUNG</td>
            <td style="width: 10px;">:</td>
            <td class="left">{{$idgedung}}</td>
        </tr>
        <tr>
            <td class="left">Gedung</td>
            <td style="width: 10px;">:</td>
            <td class="left">{{$uraiangedung}}</td>
        </tr>
        ...
        <tr>
            <td></td>
            <td></td>
            <td colspan="3" class="left" style="padding-top: 20px;"><img class="qr-code" src="{{'data:image/svg+xml;base64,'.base64_encode(file_get_contents(asset('storage/qrdbrfinal/DBRGedung'.$idgedung.'.svg')))}}" /></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
