...
<header>
    <img src="{{ env('APP_URL')."/".asset('storage/kopsurat/KOP2.png')}}" width="100%" height="100%"/>
</header>
<center>
...
<table>
    ...
    <tbody>
    <tr>
        <td colspan="4"><img src="{{ env('APP_URL')."/".asset('storage/qrbmn/DBR'.$iddbr.'.svg')}}" /></td>
        <td colspan="3"><img src="{{ env('APP_URL')."/".asset('storage/qrunit/DBR'.$iddbr.'.svg')}}" /></td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="center" colspan="7"><img src="{{ env('APP_URL')."/".asset('storage/qrdbrfinal/DBR'.$iddbr.'.svg')}}" /></td>
    </tr>
    </tfoot>
</table>
