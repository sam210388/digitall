...
<table>
    ...
    <tr>
        ...
        <td colspan="3"><img src="{{'data:image/svg+xml;base64,'.base64_encode(file_get_contents(asset('storage/qrunit/DBRGedung'.$idgedung.'.svg')))}}" /></td>
    </tr>
    <tr>
        <td colspan="4">{{$namapenandatangan}} </td>
    ...
    <tr>
        <td align="center" colspan="7"><img src="{{'data:image/svg+xml;base64,'.base64_encode(file_get_contents(asset('storage/qrdbrfinal/DBRGedung'.$idgedung.'.svg')))}}" /></td>
    </tr>
    </tfoot>
</table>
...
<table class='table table-bordered table-dbr'>
    ...
    <tr>
       <td colspan="7">Lampiran Daftar Barang Ruangan Untuk Seluruh Gedung ID {{$idgedung}}</td>
    </tr>
    </thead>
    <thead>
    <tr>
