                                        ...
                                        <form id="formbagian" name="formbagian" class="form-horizontal">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control jenistabel" name="jenistabel" id="jenistabel" style="width: 100%;" readonly>
                                            ...
                                            <fieldset id="tanahFieldset">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control tujuanrencana" name="tujuanrencana" id="tujuanrencana" style="width: 100%;" readonly>
                                                    ...
                                                    <div class="col-sm-6" id="atrNonAtrDiv">
                                                        ...
                                                        <select class="form-control atrnonatr" name="atrnonatr" id="atrnonatr" style="width: 100%;" readonly>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control jeniskantor" name="jeniskantor" id="jeniskantor" style="width: 100%;" readonly>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control jenispengadaan" name="jenispengadaan" id="jenispengadaan" style="width: 100%;" readonly>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <textarea class="form-control" id="lokasi" name="lokasi" placeholder="Lokasi" value="" required="" readonly></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="nilaibukti" class="control-label">Luas</label>
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control luas" id="luas" name="luas" placeholder="Luas" value="" required="" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
                                            <fieldset id="kendaraanJabatanFieldset">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control pejabatpemakai" name="pejabatpemakai" id="pejabatpemakai" style="width: 100%;" readonly>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control spesifikasi" name="spesifikasi" id="spesifikasi" style="width: 100%;" readonly>
                                            ...
                                            <fieldset id="kendaraanOperasionalFieldset">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control jenissatker" name="jenissatker" id="jenissatker" style="width: 100%;" readonly>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control jeniskendaraan" name="jeniskendaraan" id="jeniskendaraan" style="width: 100%;" readonly>
                                            ...
                                            <fieldset id="informasiUmum">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control skema" name="skema" id="skema" style="width: 100%;" readonly>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control program" name="program" id="program" style="width: 100%;" readonly>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control kegiatan" name="kegiatan" id="kegiatan" style="width: 100%;" readonly>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control output" name="output" id="output" style="width: 100%;" readonly>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control kodebarang" name="kodebarang" id="kodebarang" style="width: 100%;" readonly>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <textarea class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan" value="" required="" readonly></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control idbagianpelaksana" name="idbagianpelaksana" id="idbagianpelaksana" style="width: 100%;" readonly>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control tahunpengadaan" name="tahunpengadaan" id="tahunpengadaan" style="width: 100%;" readonly>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="number" class="form-control" id="quantitas" name="quantitas" placeholder="Kuantitas Pengajuan" value="" required="" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="nilaibukti" class="control-label">Harga Barang</label>
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control" id="hargabarang" name="hargabarang" placeholder="Harga Barang" value="" required="" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control tahunpelaksanaan" name="tahunpelaksanaan" id="tahunpelaksanaan" style="width: 100%;">
                                                        <option value="">Pilih Tahun Pengadaan</option>
                                                        @foreach($datatahunanggaran as $data)
                                                            <option value="{{ $data }}">{{ $data }}</option>
                                                        @endforeach
        ...
        $(function () {
            ...
            $('input[type=radio][name=setujutolak]').change(function() {
                if (this.value === 'setuju') {
                    $('#tahunpelaksanaan').prop('disabled', false);
                    $('#keterangan').prop('disabled', true);
                }
                else if (this.value === 'tolak') {
                    $('#tahunpelaksanaan').prop('disabled', 'disabled');
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                    data: fd,
                    url: "{{route('prosespersetujuanpelaksana','')}}"+'/'+id,
                    type: "POST",
                    dataType: 'json',
                    contentType: false,
                    processData: false,
