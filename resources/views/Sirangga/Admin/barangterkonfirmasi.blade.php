                        ...
                        <div class="col-12 col-sm-6">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Total Barang Terkonfirmasi</span>
                                    <span class="info-box-number">
                                 {{$totalbarangterkonfirmasi}}
                            </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="info-box">
                                <span class="info-box-icon bg-info elevation-1"><i class="fas fa-cog"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Belum Status Usul</span>
                                    <span class="info-box-number">
                                 {{$belumstatususul}}
                            </span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="info-box">
                                <span class="info-box-icon bg-info elevation-1"><i class="fas fa-cog"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Belum Status Hapus</span>
                                    <span class="info-box-number">
                                 {{$belumstatushapus}}
                            </span>
                                </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="info-box">
                                <span class="info-box-icon bg-info elevation-1"><i class="fas fa-cog"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Belum Status Henti</span>
                                    <span class="info-box-number">
                                 {{$belumstatushenti}}
                            </span>
                                </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.tabeldetildbr').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax:"{{route('getdatabarangterkonfirmasi','')}}",
                columns: [
            ...
            $('#saveBtn').click(function (e) {
                ...
                window.location="{{URL::to('exportbarangterkonfirmasi')}}"+"/"+statusbarang;
            ...
            $('body').on('click', '.delete', function () {
                ...
                if(confirm("Apakah Anda Yakin Akan Mendelete Barang Terkonfirmasi dan Mengembalikannya Ke Daftar Barang Siap Di DBR?")){
                    $.ajax({
                        url: "{{url('deletebarangterkonfirmasi')}}",
                        type: "POST",
                        data: {
                            idbarang: idbarang,
                            _token: '{{csrf_token()}}'
