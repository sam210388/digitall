                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="formkasbon" name="formkasbon" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label for="peruntukan" class="col-sm-6 control-label">Keterangan PPK</label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control keteranganppk" id="keteranganppk" name="keteranganppk" placeholder="Keterangan PPK" value="" maxlength="500" required>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('body').on('click', '.prosestransaksi', function () {
                var id = $(this).data('id');
                $.get("{{ route('editkasbonppk','') }}" +'/' + id , function (data) {
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                    data: fd,
                    url: "{{route('prosespengajuankasbonppk')}}",
                    type: "POST",
                    dataType: 'json',
                    contentType: false,
                    processData: false,
