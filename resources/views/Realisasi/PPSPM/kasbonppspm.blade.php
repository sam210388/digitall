                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="formkasbon" name="formkasbon" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label for="keteranganppspm" class="col-sm-6 control-label">Keterangan PPSPM</label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control keteranganppspm" id="keteranganppspm" name="keteranganppspm" placeholder="Keterangan PPSPM" value="" maxlength="500" required>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('body').on('click', '.prosestransaksi', function () {
                var id = $(this).data('id');
                $.get("{{ route('editkasbonppspm','') }}" +'/' + id , function (data) {
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                    data: fd,
                    url: "{{route('prosespengajuankasbonppspm')}}",
                    type: "POST",
                    dataType: 'json',
                    contentType: false,
                    processData: false,
