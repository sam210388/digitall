                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="formpenyewa" name="formpenyewa" class="form-horizontal">
                                            ...
                                            <input type="hidden" name="kopsuratawal" id="kopsuratawal">
                                            ...
                                            <div class="input-group">
                                                <label for="file" class="col-sm-6 control-label">Kop Surat</label>
                                                <div class="col-sm-12">
                                                    <div class="input-group mb-3">
                                                        <div class="custom-file">
                                                            <input type="file" accept=".gif,.jpg,.jpeg,.png,.pdf" class="custom-file-input" id="kopsurat" name="kopsurat">
                                                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                                                            <p>Ukuran terbaik adalah 1150px x 177px</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" id="linkfilekopsurat" aria-hidden="true">
                                                <div class="col-sm-12">
                                                    <a href="#" id="aktuallihatkopsurat">Lihat KOP</a>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.tabelpenyewa').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax:"{{route('getdatareferensipenyewa')}}",
                columns: [
                    {data:'id',name:'id'},
            ...
            $('body').on('click', '.editpenyewa', function () {
                ...
                $.get("{{ route('penyewa.index') }}" +'/' + id +'/edit', function (data) {
                    ...
                    $('#kopsuratawal').val(data.kopsurat);
                    ...
                    document.getElementById('aktuallihatkopsurat').href = "{{env('APP_URL')."/".asset('storage/dokpemanfaatan/kopsurat')}}"+"/"+data.kopsurat
                })
            });
            ...
            $('body').on('click', '.deletepenyewa', function () {
                ...
                var idpenyewa = $(this).data("id");
                if(confirm("Apakah Anda Yakin AKan Hapus Data Ini!")){
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('penyewa.destroy','') }}"+'/'+idpenyewa,
                        success: function (data) {
                            if (data.status == "berhasil"){
                                Swal.fire({
                                    title: 'Sukses',
