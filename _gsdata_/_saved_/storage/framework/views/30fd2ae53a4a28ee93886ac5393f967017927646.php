    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.tabeldbr').DataTable({
                ...
                ajax: "<?php echo e(route('getdatadbrbagian')); ?>",
                columns: [
            ...
            $('body').on('click', '.laporpenambahan', function () {
                ...
                if(confirm("Apakah Anda Yakin AKan Mengajukan Perubahan Pada DBR Ini?")){
                    $.ajax({
                        url: "<?php echo e(url('/laporperubahan')); ?>"+'/'+iddbr,
            ...
            $('body').on('click', '.lihatdbr', function () {
                var iddbr = $(this).data("id");
                window.location="<?php echo e(URL::to('lihatdbrbagian')); ?>"+"/"+iddbr;
            });
            ...
            $('#saveBtnTolak').click(function (e) {
                ...
                $.ajax({
                    data: fd,
                    url: "<?php echo e(route('penolakandbr','')); ?>"+"/"+iddbr,
                    type: "POST",
                    dataType: 'json',
                    contentType: false,
                    processData: false,
            ...
            $('body').on('click', '.setujuidbr', function () {
                ...
                if(confirm("Apakah Anda Yakin AKan Menyetujui Data Ini? " +
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/setujuidbr')); ?>"+'/'+iddbr,
                        success: function (data) {
                            if (data.status == "berhasil"){
                                Swal.fire({
                                    title: 'Sukses',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digitall\resources\views/Sirangga/Bagian/dbrbagian.blade.php ENDPATH**/ ?>