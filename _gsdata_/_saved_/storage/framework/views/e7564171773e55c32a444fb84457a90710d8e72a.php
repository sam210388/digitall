                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control program" name="program" id="program" style="width: 100%;">
                                                        ...
                                                        <?php $__currentLoopData = $dataprogram; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($data->kode); ?>"><?php echo e($data->kode." | ".$data->uraianprogram); ?></option>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control kegiatan" name="kegiatan" id="kegiatan" style="width: 100%;">
                                                        ...
                                                        <?php $__currentLoopData = $datakegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($data->kode); ?>"><?php echo e($data->kode." | ".$data->deskripsi); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control idbagianpelaksana" name="idbagianpelaksana" id="idbagianpelaksana" style="width: 100%;">
                                                        ...
                                                        <?php $__currentLoopData = $databagianrk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($data->idbagian); ?>"><?php echo e($data->uraianbagian); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control tahunpengadaan" name="tahunpengadaan" id="tahunpengadaan" style="width: 100%;">
                                                        ...
                                                        <?php $__currentLoopData = $datatahunanggaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control kodebarang" name="kodebarang" id="kodebarang" style="width: 100%;">
                                                        ...
                                                        <?php $__currentLoopData = $databmnrk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($data->kdbrg); ?>"><?php echo e($data->deskripsi); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                <div class="col-sm-6">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var table = $('.tabelbagian').DataTable({
                ...
                ajax:"<?php echo e(route('pengajuanrkbmnbagian.index')); ?>",
                columns: [
                    {data: 'id', name: 'id'},
            ...
            $('#kegiatan').on('change', function () {
                ...
                $.ajax({
                    url: "<?php echo e(url('ambildataoutput')); ?>",
                    type: "POST",
                    data: {
            ...
            $('body').on('click', '.kirimkepelaksana', function () {
                ...
                if(confirm("Apakah Anda Yakin AKan Kirim Data Ini Ke Unit Kerja Pelaksana Pengadaan?")){
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(url('kirimkepelaksanapengadaan','')); ?>"+"/"+id,
            ...
            $('body').on('click', '.editpengajuan', function () {
                var id = $(this).data('id');
                $.get("<?php echo e(route('pengajuanrkbmnbagian.index')); ?>" +'/' + id +'/edit', function (data) {
                    ...
                    document.getElementById('aktuallinkbukti').href = "<?php echo e(env('APP_URL')."/".asset('storage')); ?>"+"/"+data.dokumenpendukung
                    hitungtotalanggaran();
                })
            });
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                    data: fd,
                    url: saveBtn === "tambah" ? "<?php echo e(route('pengajuanrkbmnbagian.store')); ?>":"<?php echo e(route('pengajuanrkbmnbagian.update','')); ?>"+'/'+id,
                    type: "POST",
                    dataType: 'json',
                    contentType: false,
                    processData: false,
            ...
            $('body').on('click', '.deletepengajuan', function () {
                ...
                if(confirm("Apakah Anda Yakin AKan Hapus Data Ini!")){
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('pengajuanrkbmnbagian.destroy','')); ?>"+'/'+id,
                        success: function (data) {
                            if (data.status == "berhasil"){
                                Swal.fire({
                                    title: 'Sukses',
            ...
            $('#kodebarang').on('change', function () {
                ...
                $.ajax({
                    url: "<?php echo e(url('ambildatabarangdalamdbr')); ?>",
                    type: "POST",
                    data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digitall\resources\views/PerencanaanBMN/Bagian/pengajuanrkbmnbagian.blade.php ENDPATH**/ ?>