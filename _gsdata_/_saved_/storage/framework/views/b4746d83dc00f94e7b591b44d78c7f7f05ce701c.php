    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.tabelbagian').DataTable({
                ...
                ajax:"<?php echo e(route('persetujuanusulanrkbmn')); ?>",
                columns: [
                    {data: 'id', name: 'id'},
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                    data: fd,
                    url: "<?php echo e(route('prosespersetujuanbmn','')); ?>"+'/'+id,
                    type: "POST",
                    dataType: 'json',
                    contentType: false,
                    processData: false,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\digitall\resources\views/PerencanaanBMN/Admin/pengajuanrkbmn.blade.php ENDPATH**/ ?>